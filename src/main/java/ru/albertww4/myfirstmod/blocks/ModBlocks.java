...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> Rybi_block = registerBlock("rybi_block", () -> new Block(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops().sound(SoundType.AMETHYST)));
